...
<div id="page-content">
    <div class="block full">
        <div class="block-title">
            <h2><strong>Image</strong> List</h2>
            <h2 style="float: right;"><a href="{{route('admin.image.create')}}" class="btn btn-primary">ADD Image</a></h2>
        <br><br>
            ...
            <table id="example" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody id="tableData">
                    ...
                    <tr id="image{{$n->id}}">
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{route('admin.image.edit', $n->slug)}}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default edit"><i class="fa fa-pencil"></i></a>
                                @if(Auth::guard('admin')->user()->role == 1)
                                  <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger remove_button" url="{{route('admin.image.destroy', $n->id)}}"><i class="fa fa-times"></i></a>
                                @endif
                            </div>
                        </td>
                    </tr>
...
{{-- for change status switchery --}}
   <script>
        ...
        $('tbody').delegate('.status-switch', 'change', function(){
            ...
            $.post('{{route('admin.change.image.status')}}',{'_token':'{{csrf_token()}}',news_id:newsId, status:chk}, function(){
