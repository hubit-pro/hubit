                        ...
                        <ul class="nav navbar-nav-custom pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                    ...
                                    <li>
                                        {{-- @if(!Auth::guard('admin')->user()->adminDetail)
                                        <a href="{{route('admin.create.profile', Auth::guard('admin')->user()->slug)}}">
                                        @else
                                        <a href="{{route('admin.edit.profile', Auth::guard('admin')->user()->adminDetail->slug)}}">
                                        @endif --}}
