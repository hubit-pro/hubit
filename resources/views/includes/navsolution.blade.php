...
<nav class="navbar navbar-expand-sm navbar-dark sticky-top" id="head" style="position:sticky">
  		...
  		<div class="collapse navbar-collapse" id="collapsibleNavbar">
    		<ul class="navbar-nav">
      			...
      			<li class="nav-item">
        			<a class="nav-link" style="color:white;" href="home-solution">Home</a>
      			</li>
      			...
      			<li class="nav-item">
        			<a class="nav-link" style="color:white;" href="clients">Clients</a>
      			</li>

      			<li class="nav-item">
        			<a class="nav-link" style="color:white;" href="career-solution">Career</a>
      			</li> 

      			<li class="nav-item">
        			<a class="nav-link" style="color:white;" href="gallery">Gallery</a>
      			</li>

      			<li class="nav-item">
        			<a class="nav-link" style="color:white;" href="contact-solutions">Contact Us</a>
      			</li>
    		</ul>
  		</div> 
	</nav>