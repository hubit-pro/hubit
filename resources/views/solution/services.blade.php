...
<section class="container-fluid pb-5">
     ...
     <div id="veaw-pot">
       <div id="veaw-pot1">
        ...
        <!-------corporate and buisness IT consultant---->
        <div class="row cmt-cont">

            <div class="col-xl-12  text-center cmt-cont-h3">
              <h4>Corporate and Business IT Consultant</h4>
            </div>
            ...
            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInRight" data-delay="500" id="cmt-cont-img1">
                <img style="height: 150px; width: 100%;" src="img/image8.png">
            </div>
        ...
        <div class="row cmt-cont">
            ...
            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInRight" data-delay="400" id="cmt-cont-img3">
              <img style="height: 150px; width: 100%;" src="img/images6.png">
            </div>
        ...
        <div class="row cmt-cont">
            ...
            <div class="col-xl-12 text-center cmt-cont-h3">
                <h4>Surveillance System (CCTV) </h4>
            </div>

            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInLeft" data-delay="500" id="cmt-cont-img6">
              <img style="height: 150px; width: 100%;" src="img/image9.png">
            </div>
        ...
        <div class="row cmt-cont">
            ...
            <div class="col-xl-12 text-center cmt-cont-h3">
                <h4>Intercomm System Installation</h4>
            </div>

            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInLeft" data-delay="500" id="cmt-cont-img8">
              <img style="height: 150px; width: 100%;" src="img/image11.jpg">
            </div>
            ...
            <div class="col-xl-9 p-4 text-justify">
                <div class="cmt-cont-child animated standby slideInRight" style="font-weight:500"data-delay="500">
                  ...
                  <ul >Benefits of this product to your organization:-
                    ...
                    <li>Single PSTN line for the whole organization block.</li> 
                    <li>The cost of telephone communication within the organization is basically free.</li> 
                    <li>We can add More PSTN line to the main line.</li>
                  </ul>
                </div>
            </div>           
        ...
        <div class="row cmt-cont">
            ...
            <div class="col-xl-12 text-center cmt-cont-h3">
                <h4>Biometric Devices (Attendance System)</h4>
            </div>
            ...
            <div class="col-xl-9 p-4 text-justify">
                <div class="cmt-cont-child animated standby slideInLeft"style="font-weight:500" data-delay="500">
                  ...
                  <ul >Benefits of this product to your organization:-
                    ...
                    <li>Increase Employee Accountability Thanks to Audit Trails</li>
                    <li>Enhanced Job Satisfaction</li>
                  </ul>
                </div>  
            </div>

            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInRight" data-delay="500" id="cmt-cont-img9">
              <img style="height: 150px; width: 100%;" src="img/image12.png">
            </div>
        ...
        <div class="row cmt-cont">
            ...
            <div class="col-xl-3 p-4 cmt-cont-img animated standby slideInLeft" data-delay="500" id="cmt-cont-img8">
              <img style="height: 150px; width: 100%;" src="img/images13.png">
            </div>
            ...
            <div class="col-xl-9 p-4 text-justify">
                <div class="cmt-cont-child animated standby slideInRight"style="font-weight:500" data-delay="500">
                  ...
                  <ul >Benefits of this product to your organization:-
                    ...
                    <li>You don’t have to my every year.</li> 
                    <li>Certain types of fire extinguisher and leaves your appliances undamaged.</li>
                  </ul>
                </div>
            </div>           
