		...
		<div class="row pl-5 cardo">
			...
			<div class="col-xl-2 ml-4 mt-1">
				<div class="row card">
					...
					<div class="col-xl-12 pt-1 pb-1" style="background-color: lightgray;">
						<a href="http://lca.hubit.com.np/">
							<h6>Link of the website</h6>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="col-xl-2 ml-4 mt-1">
				<div class="row card">
					...
					<div class="col-xl-12 pt-1 pb-1" style="background-color: lightgray;">
						<a href="http://hotelpeacezone.com/">
							<h6>Link of the website</h6>
						</a>
					</div>
				</div>
			...
			<div class="col-xl-2 ml-4 mt-1">
				<div class="row card">
					...
					<div class="col-xl-12 pt-1 pb-1" style="background-color: lightgray;">
						<a href="http://lumbinicomfortinn.com/">
							<h6>Link of the website</h6>
						</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-xl-2 text-center">
				<div class="row">
					...
					<div class="col-xl-12 pt-3">
						<a style="color: black;" href="gallery">
							<h6>Hotel Lumbini Comfort Inn</h6>
						</a>
					</div>
				</div>
			</div>
