...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/training/blogs.css">
@include('includes/traininghead')
  ...
  <link href="css1/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <div class="post-entry-2 d-flex">
              <div class="thumbnail order-md-2" style="background-image: url('img/img_h_4.jpg')"></div>
            ...
            <div class="post-entry-2 d-flex">
              <div class="thumbnail order-md-2" style="background-image: url('img/img_h_3.jpg')"></div>
              <div class="contents order-md-1 pl-0">
                <h2><a href="blog-single.html">News Needs to Meet Its Audiences Where They Are</a></h2>
                <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi temporibus praesentium neque, voluptatum quam quibusdam.</p>
                <div class="post-meta">
            ...
            <div class="post-entry-2 d-flex">
              <div class="thumbnail order-md-2" style="background-image: url('img/img_h_1.jpg')"></div>
              <div class="contents order-md-1 pl-0">
