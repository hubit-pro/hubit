          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                ...
                <li>
                    <a href="contact-blogs" class="nav-link text-left">Contact</a>
                </li>
              </ul>                                                                                                                                                                                                                                                                                         
            </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 single-content">
            ...
            <p class="mb-5">
              <img src="img/big_img_1.jpg" alt="Image" class="img-fluid">
            </p>  
            <h1 class="mb-4">
            ...
            <div class="post-meta d-flex mb-5">
              <div class="bio-pic mr-3">
                <img src="img/person_1.jpg" alt="Image" class="img-fluidid">
              </div>
              <div class="vcard">
