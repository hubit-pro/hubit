...
<div class="row">
  ...
  <div class="col-lg-3 col-md-6 mt-3">
    ...
    <a><img class="img-fluid " src="img/s.jpg" alt="img" 
        data-toggle="modal" data-target="#modal1">
        <div class="middle">
        <p class="text">HARI BANJADE</p>
        </div>
        </a>
        </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/birajan.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/birajan.jpg" alt="img" 
    data-toggle="modal" data-target="#modal8">
    <div class="middle">
    <p class="text">BIRAJAN</p>
    </div>
    </a>
    </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/hari.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/hari.jpg" alt="img" 
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/lara.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/lara.jpg" alt="img" 
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/sam.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/sam.jpg" alt="img" 
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/per1.jpeg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/per1.jpeg" alt="img" 
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/per.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/per.jpg" alt="img" 
      ...
      <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <img class="embed-responsive-item" src="img/pac.jpg"
                allowfullscreen></img>
            </div>
...
<a><img class="img-fluid " src="img/pac.jpg" alt="img" 
