...
define('SECRET_SALT','f627bfccfd5a215f3e6a11643f84d520');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@hubit.com.np');
...
define('DBNAME','hubitcom_osti702');
define('DBUSER','hubitcom_osti702');
define('DBPASS','S[jy(p77K0');

# Table prefix
define('TABLE_PREFIX','ostrb_');
