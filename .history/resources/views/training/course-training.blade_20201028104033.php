					...
					<div class="sidebar">
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_categories">
								<ul>
									<li><input type="text" placeholder="Your full name" style="width: 100%; border:none;"></li>
									<li><input type="email" placeholder="Your email" style="width: 100%; border:none;"></li>
									<li><input type="number" placeholder="Your mobile No." style="width: 100%; border:none;"></li>
									<li><input type="textbox" placeholder="Your enquiry" style="width: 100%; border:none;"></li>
									<li><input type="submit" placeholder="Your full name" style="width: 100%; border:none;"></li>
								</ul>
							</div>
						</div>
